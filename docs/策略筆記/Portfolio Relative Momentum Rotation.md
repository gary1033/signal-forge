...
- Adjusted grid search 已補上。下一步不要繼續擴同一組 top-N / breadth / max-consecutive 小網格；優先對 `top3 / breadth4 / maxconsec5 / liq500M` 產生 raw/adjusted comparison artifact，再做 group regime validation 或更高品質股票池，確認 rolling group concentration 是否能下降。

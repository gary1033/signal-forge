...
- 針對 portfolio rotation，下一步不要直接宣稱穩定營利；`breadth lookback 42 / min positive 2` 雖把 full-window IR 提到約 `1.017` 並把 MDD 降到約 `-21.11%`，但 2021-2022 仍輸給 benchmark。後續應先擴大股票池、補 1x / 2x / 3x cost stress 固定報表，或測 canary / re-entry 條件，確認它不是只吃到七檔股票池與 2024-2026 強勢行情。

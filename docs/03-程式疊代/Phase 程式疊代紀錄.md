...
- `tests\test_portfolio_rotation_sweep_tool.py` 新增 parser、共同日期對齊、top momentum 選股、benchmark 成本、market regime block、breadth block、volatility scaling、retention、symbol attribution、連續入選上限、group cap、單成員群組 gate 與 liquidity filter regression。

...
| 2026-05-19 23:41 | Phase CLI: rely on `PhaseConfig` derived `dry_run` | 110 -> 110 | pass | keep | `77ca204` (pushed) | Remove redundant CLI wiring; keep single source of truth in `PhaseConfig` |

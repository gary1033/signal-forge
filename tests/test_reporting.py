...
class ReportingTests(unittest.TestCase):
    ...
    def test_entry_edge_outputs_have_stable_contract(self) -> None:
        ...
        expected_summary = {
            ...
            "metrics": {
                ...
                "benchmark_cagr": None,
                "benchmark_end_equity": 11000.0,
                "benchmark_excess_cagr": None,
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    ...
                    "- Calmar ratio: undefined",
                    "- Average net PnL: 1000.00",
                    "- Max drawdown: 0.00%",
                    "- Benchmark excess return: 0.00%",
                    ...
                    "- Commission (bps): 0.00",
                    "- Slippage (bps): 0.00",
                    "- Transaction tax on exit (bps): 0.00",
                    "- Fixed hold bars: 1",
                    ...
                    "## Benchmark",
                    "",
                    "- Buy and hold end equity: 11000.00",
                    "- Buy and hold total return: 10.00%",
                    "- Buy and hold CAGR: undefined",
                    "- Buy and hold max drawdown: 0.00%",
                    "- Excess CAGR: undefined",
                    "",
                    "## Period Returns",
                    "",
                    "- Monthly periods: 1",
    ...
    def test_entry_edge_markdown_promotes_full_bar_as_primary_twse_benchmark(self) -> None:
        """
        用途與流程：驗證當 strategy spec 顯示 TWSE 已知樣本且啟用 full bar above range 時，entry-edge markdown 會把它標成台股 primary structural benchmark，避免 benchmark hint 仍停留在舊的 OR 平均量基準排序。
        參數：self 表示目前 unittest 測試案例。
        回傳與錯誤：回傳 None；assertion 失敗時由 unittest 回報。
        """
        bars = [
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            paths = write_entry_edge_outputs(
                result,
                temp_dir,
                run_name="entry-edge-twse-fullbar-benchmark",
                data_validation=validate_bars(bars),
                strategy_spec={
                    "entry_side": "long_only",
                    "orb_known_sample_market_clock_alignment": "aligned",
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    ...
                    "|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|",
                    "| 2 | PASS | infinite | Infinity | 1 | 100.00% | 50.00% | undefined | undefined | undefined | undefined | 0.00% | 0.00% | 0 | 0 | 0 | - |",
                    "| 1 | PASS | infinite | Infinity | 1 | 100.00% | 20.00% | undefined | undefined | undefined | undefined | 0.00% | -30.00% | 0 | 0 | 0 | - |",
                    "",
                    "## Backtest Settings",
                    "",
                    "- Initial equity: 10000.00",
